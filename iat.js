...
define(['https://github.com/spartacusserdan/iatez/iat.js'], function(iatExtension){
	return iatExtension({
		category1 : {
...
define(['piManager','pipAPI','pipScorer','underscore'], function(APIConstructor, Scorer, _) {
